...
export default {
  ...
  methods: {
    ...
    refreshScreen: function() {
      ...
      this.lghrAPIRequest(this, "followers", {}, "POST",
          function(responseData, vueObj) { // on success
            ...
            if (resultList.length >= 20) {
              vueObj.title = "Below you can find a small list (up to 20) of users that are following you";
            } else if (resultList.length >0 ) {
              vueObj.title = "Below you can find a list of users that are following you";
            } else {
              vueObj.title = "You don't have any followers";
            }
